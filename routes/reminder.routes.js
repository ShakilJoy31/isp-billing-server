...
const { createReminder, createBulkReminders, getAllReminders, getReminderById, updateReminder, deleteReminder, sendReminder, cancelReminder, getReminderStats } = require("../controller/reminder/reminder.controller");
