...
const ChatMessage = sequelize.define(
  "ChatMessage",
  {
    ...
    chatId: {
      ...
      allowNull: false,
      references: {
        model: "chats", // Reference by table name
        key: "id",
      },
    },
    senderId: {
...
// Define associations with explicit table names and aliases
Chat.hasMany(ChatMessage, { 
  foreignKey: "chatId", 
  onDelete: "CASCADE",
  as: 'chatmessages' // lowercase alias to match table
});

ChatMessage.belongsTo(Chat, { 
  foreignKey: "chatId",
  as: 'chat' // lowercase alias
});

Chat.hasMany(ChatParticipant, { 
  foreignKey: "chatId", 
  onDelete: "CASCADE",
  as: 'chatparticipants' // lowercase alias to match table
});
...
// Also add these aliases for backward compatibility
Chat.hasMany(ChatMessage, { 
  foreignKey: "chatId", 
  onDelete: "CASCADE",
  as: 'ChatMessages' // Keep uppercase for compatibility
});

Chat.hasMany(ChatParticipant, { 
  foreignKey: "chatId", 
  onDelete: "CASCADE",
  as: 'ChatParticipants' // Keep uppercase for compatibility
});
